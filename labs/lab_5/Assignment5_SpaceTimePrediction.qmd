...
```{r load_indego}
# Read Q3 2024 data
indego_q3<- read_csv(here("labs/lab_5/data/indego-trips-2024-q3.csv"))
# Read Q1 2025 data
...
## 13 Temporal features: School calendar

### 13.1 Add School Feature
...
### 13.3 Build Model 6 (+School features)
...
### 13.4 Evaluate Model 6 (+School features)
...
## 14 Weather features: Weekend + nice weather interaction

### 14.1 Add Weather Interaction
...
### 14.3 Build Model 7(+ Weather Interaction)
...
## 15 Attempt for Poisson Model

### 15.1 Build Model 8 (Poisson)
...
### 16.1 Is your final MAE "good enough" for Indego to use?
...
### 16.2 When do prediction errors cause problems for rebalancing?
...
### 16.3 Would you recommend deploying this system? Under what conditions?
...
## 17 Equity considerations

### 17.1 Do prediction errors disproportionately affect certain neighborhoods?
...
### 17.2 Could this system worsen existing disparities in bike access?
...
### 17.3 What safeguards would you recommend?
...
### 18.1 What patterns is your model missing?
...
### 18.2 What assumptions might not hold in real deployment?
...
### 18.3 How would you improve this with more time/data?
