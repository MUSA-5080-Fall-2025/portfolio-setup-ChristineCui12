...
census_api_key(Sys.getenv("20068788c6e79d5716fbceb0dcd562ab23f74ca1"))
...
```{r}
# Search for population-related variables  (string)
...
housing_vars <- acs_vars_2022 %>%
  filter(str_detect(label, "[Mm]edian.*(rent|value)"))     # |or
...
ggplot(county_data) +
  ...
  geom_histogram(bins = 15, fill = "Darkseagreen", alpha = 0.7) +    #decorate
  labs(
